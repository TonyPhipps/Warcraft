...
addonTable.PROMOTE_ASSISTANT = true;
addonTable.PROMOTE_LEADER = true;
addonTable.SHARE_QUESTS = true;


-- PVP
addonTable.ACCEPT_RESURRECT = true;
addonTable.RELEASE_PVP = true;
addonTable.RELEASE_WORLD = true;


-- Miscellaneous
addonTable.SCREENSHOT_ACHIEVEMENTS = true;
addonTable.TOGGLE_CINEMATIC_SOUND = true;
