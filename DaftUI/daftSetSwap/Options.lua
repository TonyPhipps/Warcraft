...
-- TODO: grab specialization names and show them on options pane
-- _, spec1Name = GetSpecializationInfo(1);
-- _, spec2Name = GetSpecializationInfo(2);
-- _, spec3Name = GetSpecializationInfo(3);
-- _, spec4Name = GetSpecializationInfo(4);